...
from DeepQNetwork import Agent, DeepQNetwork
...
if __name__ == '__main__':
    ...
    agent = Agent(gamma=0.99, epsilon=1.0, batch_size=64, n_actions=4,
                eps_min=0.01, input_dims=[16], lr=0.01)
    
    model = DeepQNetwork(n_actions=4, input_dims=[16], lr=0.01, fc1_dims=256, fc2_dims=256)
    model.load_state_dict(torch.load('277_best_MC_model.pth', 
